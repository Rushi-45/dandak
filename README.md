...
| Data records | 106 spots (91 verified: T1 100%, T2 81%) + 48 companions (2 districts, 12 itineraries, 8 events, 16 stays, 10 foods); 28 spots with imagery (CC/Commons + maintainer's own) |
